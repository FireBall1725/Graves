package com.fireball1725.graves.common.reference;
...
public class ModInfo {
    ...
    public static final String DEPENDENCIES = "required-before:fusionlordspatrons;";
    public static final String COMMON_PROXY_CLASS = "com.fireball1725." + MOD_ID + ".proxy.CommonProxy";
    ...
    public static final String PATRONS_INFO = "https://raw.githubusercontent.com/FusionLord/FusionLordsPatrons/master/webassets/patrons.json";
}
